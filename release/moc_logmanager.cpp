...
QT_MOC_LITERAL(1, 11, 6), // "newLog"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 16) // "formattedMessage"

    },
    "LogManager\0newLog\0\0formattedMessage"
};
...
void LogManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LogManager *_t = static_cast<LogManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (LogManager::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LogManager::newLog)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject LogManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LogManager.data,
      qt_meta_data_LogManager,  qt_static_metacall, nullptr, nullptr}
};
...
void *LogManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LogManager.stringdata0))
        return static_cast<void*>(const_cast< LogManager*>(this));
...
// SIGNAL 0
void LogManager::newLog(const QString & _t1)
{
