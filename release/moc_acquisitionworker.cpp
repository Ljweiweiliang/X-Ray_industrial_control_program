...
QT_MOC_LITERAL(4, 36, 4) // "stop"

    },
    "AcquisitionWorker\0frameReady\0\0start\0"
    "stop"
};
...
void AcquisitionWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AcquisitionWorker::frameReady)) {
                *result = 0;
                return;
            }
        }
...
void *AcquisitionWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AcquisitionWorker.stringdata0))
        return static_cast<void*>(const_cast< AcquisitionWorker*>(this));
...
// SIGNAL 0
void AcquisitionWorker::frameReady()
{
